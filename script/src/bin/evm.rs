...
use sovereign_lib::PublicValuesStruct;
...
struct SP1SovereignProofFixture {
    a: u32,
    b: u32,
    n: u32,
    vkey: String,
...
fn main() {
    ...
    // Setup the program.
    let pk = client.setup(SOVEREIGN_ELF).expect("failed to setup elf");
...
fn create_proof_fixture(
    ...
    let fixture = SP1SovereignProofFixture {
        a,
        b,
        n,
